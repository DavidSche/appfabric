...
import com.davidche.appfabric.uaa.security.JwtAuthenticationEntryPoint;
import com.davidche.appfabric.uaa.security.JwtAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) {
        web.ignoring().antMatchers("/v3/api-docs","/v3/api-docs/swagger-config","/swagger-ui/index.html", "/configuration/ui", "/swagger-resources/**", "/configuration/**",
