...
import com.davidche.appfabric.uaa.log.system.model.User;
import com.davidche.appfabric.uaa.util.DateUtil;
...
/*	@Pointcut("@annotation(com.myron.ims.annotation.SystemServiceLog)")
     ...
     * Controller层切点 注解拦截
     */
    @Pointcut("@annotation(com.davidche.appfabric.uaa.log.system.SystemControllerLog)")
