...
import com.davidche.workflow.common.notifications.dto.RecipientType;
...
public class EmailSenderProcessorImpl implements EmailSenderProcessor {
    ...
    public void process(EmailContext emailContext) {
        ...
        try {
            ...
            val htmlText = emailHtmlRepresentationBuilder.buildHtmlRepresentation(emailContext.getEmailBody().getMessage());
    ...
    private void addAttachments(MimeMessageHelper mimeMessageHelper, EmailContext emailContext) {
        ...
        val body = emailContext.getEmailBody();
